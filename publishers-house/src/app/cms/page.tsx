...
const modules = [
  { name: "Sermons", path: "/cms/sermons", description: "Manage teaching library, audio/video links, and study guides." },
  { name: "Events", path: "/cms/events", description: "Manage upcoming church events and registrations." },
  { name: "Articles", path: "/cms/articles", description: "Publish blog posts and written resources." },
  { name: "Programs", path: "/cms/programs", description: "Manage recurring church programs (FOL, Services, etc.)." },
  { name: "Leadership", path: "/cms/leadership", description: "Update pastoral and leadership profiles." },
];
